...
class Earthquake2 {
  ...
  int extractMonth(double dateNum) { return ((int)dateNum % 10000) / 100; }
     ...
     * @param data the data PARAMETER is a list of doubles that the sensor provided. Every so often is an 8-digit date followed by some values for that day
     * @param month the month PARAMETER is just a month, 1-12
     * @return the RESULT, a LinkedList of MaxHzReports, is a list of dates and readings, where each date is within the given month and is followed by a single value.
